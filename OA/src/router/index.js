...
export const asyncRouterMap = [{
  ...
  hidden: false,
  children: [
    //{ path: '/home', name:'home',icon:'ios-home', component: _import('Home') },
    { path: '/dashboard', name: 'Dashboard', icon: 'ios-speedometer', component: _import('Dashboard') },
    //{ path: '/introduction', name: '介绍', icon: 'ios-paper', component: _import('Introduction') },
    { path: '/inhabitant', name: '住户管理', icon: 'ios-contacts', component: _import('Inhabitant') },
    /* {
    ...
    { path: '/markdown', name: 'Markdown', hidden: true, component: _import('Markdown') },
    //{ path: '/jsontree', name: 'JSON视图', icon: 'merge', component: _import('JsonTree') },
    { path: '/tabledocdetail/', name: 'TableDocDetail', hidden: true, component: _import('TableDocDetail') },
    //{ path: '/tinymce', name: 'Tinymce编辑器', icon: "android-document", component: _import('Tinymce') },
    { path: '/plumb', name: '流程图', icon: 'ios-paper', component: _import('Plumb'), meta: { role: ['admin'] } },
  ]
},
